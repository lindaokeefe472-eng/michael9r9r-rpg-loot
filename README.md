...
| 文件 | 用途 |
| :--- | :--- |
| `michael9r9r-rpg-loot-datapack-v26.2.16-BUG-FIX.zip` | 数据包本体 (Data Pack) |
| `michael9r9r-rpg-loot-resourcepack-v26.2.16-BUG-FIX.zip` | 中文翻译资源包 (Resource Pack, 可选) |
...
2. 将 `michael9r9r-rpg-loot-datapack-v26.2.16-BUG-FIX.zip` **直接拖入** 弹出的文件夹窗口。
...
2. 将 `michael9r9r-rpg-loot-datapack-v26.2.16-BUG-FIX.zip` **直接复制粘贴** 到 `datapacks` 文件夹中（无需解压！）。
3. 进入游戏后，在聊天框输入：
   ```
   /reload
   ```
...
2. 将 `michael9r9r-rpg-loot-resourcepack-v26.2.16-BUG-FIX.zip` **直接复制粘贴** 到 `resourcepacks` 文件夹中（无需解压！）。
...
| 文件 | 用途 |
| :--- | :--- |
| `michael9r9r-rpg-loot-datapack-v26.2.16-BUG-FIX.zip` | 数据包本体 |
| `michael9r9r-rpg-loot-resourcepack-v26.2.16-BUG-FIX.zip` | 中文翻译资源包（可选） |
...
2. 将 `michael9r9r-rpg-loot-datapack-v26.2.16-BUG-FIX.zip` 直接**拖入**弹出的文件夹窗口。
3. 在数据包列表中点击 **▶** 箭头将其移至右侧"已选"列，点击「完成」即可。

**如果你是已有存档：**
1. 找到存档目录下的 `datapacks` 文件夹：
   - Windows 默认路径：`%appdata%\.minecraft\saves\<存档名>\datapacks\`
2. 将 `michael9r9r-rpg-loot-datapack-v26.2.16-BUG-FIX.zip` **直接复制进该文件夹**（不要解压）。
...
2. 将 `michael9r9r-rpg-loot-resourcepack-v26.2.16-BUG-FIX.zip` **直接复制进该文件夹**（不要解压）。
