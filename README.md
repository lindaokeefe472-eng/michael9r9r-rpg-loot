...
前往 [GitHub Releases](https://github.com/lindaokeefe472-eng/michael9r9r-rpg-loot/releases/tag/v26.3.1) 下载以下两个文件：

| 文件 | 适用游戏版本 | 说明 |
| :--- | :--- | :--- |
| `michael9r9r-rpg-loot-datapack-v26.3.1.zip` | **Minecraft 26.2+**(推荐) | 数据包本体,主发布版,真实服务器验证 ✅ |
| `michael9r9r-rpg-loot-datapack-v26.3.1-mc1.21.4.zip` | Minecraft 1.21 – 1.21.4 | 旧版适配构建,真实服务器验证 ✅ |
| `michael9r9r-rpg-loot-datapack-v26.3.1-mc1.21.9.zip` | Minecraft 1.21.9 – 1.21.10 | 旧版适配构建(实验性) |
| `michael9r9r-rpg-loot-datapack-v26.3.1-mc1.21.5.zip` | Minecraft 1.21.5 – 1.21.8 | 旧版适配构建(实验性) |
| `michael9r9r-rpg-loot-resourcepack-v26.3.1.zip` | 全版本通用 | 中文翻译资源包 (可选) |
...
2. 将 `michael9r9r-rpg-loot-datapack-v26.3.1.zip` **直接拖入** 弹出的文件夹窗口。
...
2. 将 `michael9r9r-rpg-loot-datapack-v26.3.1.zip` **直接复制粘贴** 到 `datapacks` 文件夹中（无需解压！）。
3. 进入游戏后，在聊天框输入：
   ```
   /reload
   ```
...
2. 将 `michael9r9r-rpg-loot-resourcepack-v26.3.1.zip` **直接复制粘贴** 到 `resourcepacks` 文件夹中（无需解压！）。
...
前往 [GitHub Releases 页面](https://github.com/lindaokeefe472-eng/michael9r9r-rpg-loot/releases/tag/v26.3.1) 下载以下两个文件：
...
2. 将 `michael9r9r-rpg-loot-datapack-v26.3.1.zip` 直接**拖入**弹出的文件夹窗口。
3. 在数据包列表中点击 **▶** 箭头将其移至右侧"已选"列，点击「完成」即可。

**如果你是已有存档：**
1. 找到存档目录下的 `datapacks` 文件夹：
   - Windows 默认路径：`%appdata%\.minecraft\saves\<存档名>\datapacks\`
2. 将 `michael9r9r-rpg-loot-datapack-v26.3.1.zip` **直接复制进该文件夹**（不要解压）。
...
2. 将 `michael9r9r-rpg-loot-resourcepack-v26.3.1.zip` **直接复制进该文件夹**（不要解压）。
...
- 📦 **[GitHub Release v26.2.34-CONTENT-UPDATE](https://github.com/lindaokeefe472-eng/michael9r9r-rpg-loot/releases/tag/v26.3.1)**: Direct ZIP downloads for Data Pack and Translation Resource Pack.
