...
execute as @e[type=bat,tag=!bat_loot] run data merge entity @s {death_loot_table:"rpgloot:legendary_items",death_loot_table:"rpgloot:legendary_items",Tags:["bat_loot"]}
