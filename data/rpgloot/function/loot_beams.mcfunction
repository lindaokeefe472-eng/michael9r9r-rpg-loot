...
execute as @e[type=minecraft:item,nbt={item:{components:{"minecraft:custom_name":'{"text":"Sacrifice"}'}}}] at @s run particle minecraft:soul_fire_flame ~ ~ ~ 0.1 2.5 0.1 0.05 10
