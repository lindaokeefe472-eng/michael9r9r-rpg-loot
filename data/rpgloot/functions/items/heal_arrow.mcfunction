...
execute at @p[distance=0..5] run summon area_effect_cloud ~ ~ ~ {Particle:spell,Radius:2f,Duration:20,Effects:[{name:"minecraft:regeneration",amplifier:1,duration:100}]}