...
execute at @e[type=minecraft:item,nbt={Item:{id:"minecraft:gold_block",components:{"minecraft:custom_name":'{"text":"Phat Loot"}'}}] positioned ~5 ~100 ~-5 run function rpgloot:summon/raid_poseidon_vassal
